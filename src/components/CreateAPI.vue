...
<div class="card-body">
    ...
    <div class="p-default p-round pretty" p-radio="">
        <input type="radio" id="no" value="false" v-model="merchants.api.is_shopify">
        <div class="state">
...
<button class="button large primary inline" @click="createMerchant(merchants.api.is_shopify,merchants.api.label,merchants.api.ipn,merchants.api.approved_currencies,merchants.api.logo,merchants.api.success,merchants.api.cancel)">Create</button>
</div></center><br>
...
export default{
  ...
  mounted(){
    ...
    methods:{
      createMerchant(is_shopify,label,ipn,currencies,logo,success,cancel){
        this.$root.error = ''
        ...
        var router = this.$router
          ...
          params.append('is_shopify', is_shopify);
